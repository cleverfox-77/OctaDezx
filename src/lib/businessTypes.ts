...
export const BUSINESS_TYPES: BusinessType[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "opening_hours", label: "Opening Hours", placeholder: "Mon–Fri 9am–8pm, Sat 10am–6pm, closed Sundays..." },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "support_channels", label: "Support Channels & Hours", placeholder: "Email support 24/7, live chat 9–5 EST, docs at..." },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "opening_hours", label: "Opening Hours", placeholder: "Daily 11am–11pm, kitchen closes 10:30pm..." },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "support_hours", label: "Support Hours & Channels", placeholder: "24/7 chat, phone 9–6, regional support contacts..." },
    ],
  },
  {
    id: "other",
